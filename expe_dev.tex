...
\begin{table}
    ...
    \hline                                                                
        \textbf{ILFM} & pvalue         & alpha           & x\_min          & n\_tail             \\            
    \hline                                                                                                    
    Network 1     & 1.0 $\pm$ 0.0    & 7.433 $\pm$ 2.181 & 1.0 $\pm$ 0.0    & 53.737 $\pm$ 9.8   \\
    Network 2     & 1.0 $\pm$ 0.0    & None $\pm$ 0.0    & 1.0 $\pm$ 0.0    & 41.895 $\pm$ 11.2  \\                             
    Network 3     & 1.0 $\pm$ 0.0    & 4.074 $\pm$ 0.706 & 1.0 $\pm$ 0.0    & 112.143 $\pm$ 18.5 \\                
    Network 4     & 1.0 $\pm$ 0.0    & 1.957 $\pm$ 0.226 & 1.0 $\pm$ 0.0    & 316.095 $\pm$ 69.5 \\
    Manufacturing & 0.55 $\pm$ 0.497 & 1.242 $\pm$ 1.156 & 0.55 $\pm$ 0.497 & 31.4 $\pm$ 14.6    \\              
    UC Irvine     & 1.0 $\pm$ 0.0    & 5.213 $\pm$ 0.902 & 1.0 $\pm$ 0.0    & 242.0 $\pm$ 26.1   \\                
    \hline                                                                
    \end{tabular}    
\end{table}
