...
\centering
	\input{img/corpus/immsb_global_table}
	\input{img/corpus/ilfm_global_table}
...
\centering
	\input{img/corpus/immsb_local_table}
	\input{img/corpus/ilfm_local_table}
...
\begin{table}
    \caption{Power law Goodness of fit for the \textbf{global} preferential attachment effect.}
\centering
\input{img/fix/immsb_homo_contingency_table}
\input{img/fix/ilfm_homo_contingency_table}
...
\begin{table}[h]
    ...
    \centering
    \input{img/fix/homo_pearson_table}
