...
Then each row of the two figure represent the three following measure that correspond respectively to global preferential attachment, the local preferential attachment and the feature burstiness:
\begin{itemize}
