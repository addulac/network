...
We believe that those questions open a way to help us developing and designing Bayesian models in order to better capture the fundamental phenomena in real social networks.
