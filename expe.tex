...
\hline                                                                             
\end{tabular}  
    \caption{immb result on synthetic networks}
\end{table}


The table \ref{table:ibp} shows the precision and recall results, for each networks. Additionally we show the number of latent features to which ILFM converged. We can see that ILFM is significantly better than MMSB at predicting over homophilic network, with a small number of features. Besides, although ilfm can achieve good results, for bursty network, we see that the models learn more features for non-bursty networks compared to ilfm. 
