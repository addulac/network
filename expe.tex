...
\begin{equation}
    \E_\M[Y_{new} | Y, \M] = F \Phi F^T
\end{equation}


The figure \ref{fig:gen_graph} shows the degree distribution of graph generated by respectively the IBP and the IMMSB for each of the datasets presented in \ref{sec:datasets}.
...
\begin{figure}[h]
	...
	\minipage{0.25\textwidth}
	\includegraphics[scale=0.4]{img/ibp_g1_d}
	\endminipage
	\minipage{0.25\textwidth}
	...
	\vspace{-0.4cm}
	\minipage{0.25\textwidth}
	\includegraphics[scale=0.4]{img/ibp_g2_d}
	\endminipage
	\minipage{0.25\textwidth}
	...
	\vspace{-0.4cm}
	\minipage{0.25\textwidth}
	\includegraphics[scale=0.4]{img/ibp_g3_d}
	\endminipage
	\minipage{0.25\textwidth}
	...
	\vspace{-0.4cm}
	\minipage{0.25\textwidth}
	\includegraphics[scale=0.4]{img/ibp_g4_d}
	\endminipage
	\minipage{0.25\textwidth}
